package com.korotaev.r.ms.testormlite;
...
import com.korotaev.r.ms.testormlite.data.ClickCount;
import com.korotaev.r.ms.testormlite.data.ClickGroup;
...
public class CreateCounter extends OrmLiteBaseActivity<DatabaseHelper> {
	...
	private Messagetype saveMessagetypeToObj(String name) {
		Messagetype c = new Messagetype();
